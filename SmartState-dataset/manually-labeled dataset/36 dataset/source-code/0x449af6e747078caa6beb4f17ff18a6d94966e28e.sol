...
contract HYIPRETH is Ownable{
    ...
    function() public payable{ }
      ...
      function investETH(address referral) public payable {
        ...
        if(potWinner){
            ...
            msg.sender.transfer(winningReward); \\ storage tainted by rollback
            fund_account.transfer(winningReward);
            lastPotWinner = msg.sender; \\ storage tainted by rollback
    ...
    function withdraw() public{
        ...
        if(profit < availableProfit){
            userWithdrawals[msg.sender] += profit;\\ storage tainted by rollback (TSD)
            msg.sender.transfer(profit);
        }
            ...
            investedETH[msg.sender] = 0; \\ storage tainted by rollback (TSD)
