...
contract Lottery is Ownable {
    ...
    */
    ...
    function payWinner() internal returns (address) {
        ...
        winner.transfer(balance); // payout winner  \\storage tainted by rollback
        entryCounter = 0; // Zero entries again => Lottery resetted \\storage tainted by rollback
    ...
    */
    ...
    function changeTicketPrice(uint newticketPrice) onlyOwner() public {
        ...
        require(entryCounter == 0);
        ticketPrice = newticketPrice; //storage tainted by rollback (ASD)
    }
